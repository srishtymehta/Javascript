let words = ['raw', 'tan', 'man', 'kite', 'abide', 'bait', 'abound', 'music', 'overseas', 'persistent'];
let scorespan = document.querySelector('#levl');
let score = 0;
scorespan.innerHTML = score;
let levelSpan = document.querySelector('#levl');
let level = 'First';
